...
(2) Move to the root directory /, then list all hidden files/directories with detailed information.
...
(5) Copy the config.txt file to the cloud-sec/labs/ directory.
...
(8) Use a wildcard to delete all .txt files in your Home directory with a single command.
